...
import ListingsStoreLayout from "@/components/layout/ListingsStoreLayout";
...
function SidebarListPage() {
    ...
    const {
        ...
        paginatedProperties,
        totalPages
    } = usePropertyList(propertyListItems, propertyFilter, "list", 12);
    ...
    return (
        <>
            <Layout>
                <InnerHeader title="Find Sidebar List" currentpage="Find Sidebar List" />
                <>
