                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-2 col-md-6 col-6">
                                <div className="vl-logo">
                                    <Link href="/">
                                        <img src="/assets/img/logo/kifah%20logo-01.png" alt="Kifah Business Park" style={{ width: '250px', height: 'auto', maxHeight: '80px', objectFit: 'contain' }} />
                                    </Link>
                                </div>
                            </div>
                                                        ...
                                                        <div className="row gx-3 row-cols-1 row-cols-md-1 row-cols-lg-4">
                                                            <div className="col">
                                                                <div className="vl-home-thumb">
                                                                    <div className="img1">
                                                                        <img src="/assets/img/all-images/demo/demo-img1.png" alt="Kifah Business Park" />
                                                                    </div>
                                                            ...
                                                            <div className="col">
                                                                <div className="vl-home-thumb">
                                                                    <div className="img1">
                                                                        <img src="/assets/img/all-images/demo/demo-img2.png" alt="Kifah Business Park" />
                                                                    </div>
                                                            ...
                                                            <div className="col ">
                                                                <div className="vl-home-thumb">
                                                                    <div className="img1">
                                                                        <img src="/assets/img/all-images/demo/demo-img3.png" alt="Kifah Business Park" />
                                                                    </div>
                                                            ...
                                                            <div className="col ">
                                                                <div className="vl-home-thumb">
                                                                    <div className="img1">
                                                                        <img src="/assets/img/all-images/demo/demo-img4.png" alt="Kifah Business Park" />
                                                                    </div>
                            ...
                            <div className="col-lg-3 col-md-6 col-6">
                                <div className="vl-hero-btn d-none d-lg-block text-end">
                                    <div className="btn-area1 dashboard">
                ...
                <div className="slide-bar slide-bar1">
                    <div className="sidebar-info">
                        ...
                        <div className="personal-info">
                            <div className="img1">
                                <img src="/assets/img/all-images/others/others-img7.png" alt="Kifah Business Park" />
                            </div>
