                    ...
                    <div className="vl-offcanvas-wrapper">
                        <div className="vl-offcanvas-header d-flex justify-content-between align-items-center mb-90">
                            <div className="vl-offcanvas-logo">
                                <Link href="/">
                                    <img src="/assets/img/logo/kifah%20logo-01.png" alt="Kifah Business Park" style={{ width: '200px', height: 'auto', maxHeight: '70px', objectFit: 'contain' }} />
                                </Link>
                            </div>
                        ...
                        <div className="vl-offcanvas-info">
                            ...
                            <span>
                                <Link href="mailto:info@kifahbusiness.so">
                                    <i className="fa-regular fa-envelope" aria-hidden /> info@kifahbusiness.so
                                </Link>
                            </span>
                            <span>
                                <Link href="tel:+252000000000">
                                    <i className="fa-solid fa-phone" aria-hidden /> +252 00 000 0000
                                </Link>
                            </span>
                            <span>
