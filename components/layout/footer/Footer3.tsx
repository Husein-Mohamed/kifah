...
export default function Footer3() {
    return (
        <>
            {/*===== FOOTER AREA STARTS =======*/}
            <div className="vl-footer3-section-area">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div className="footer-time-area">
                                <img src="/assets/img/logo/kifah%20logo-02.png" alt="Kifah Business Park" style={{ width: '220px', height: 'auto', maxHeight: '70px', objectFit: 'contain' }} />
                                <div className="space24" />
                                <p>We are committed to making your real estate journey seamless and stress-free. Whether youÃ¢â‚¬â„¢re buying, selling, or renting every step the way.</p>
                        ...
                        <div className="col-lg col-md-4">
                            ...
                            <div className="footer-widget-area">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <Link href="mailto:info@kifahbusiness.so" className="d-flex align-items-center gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                ...
                                <div className="row">
                                    <div className="col-lg-4 col-4">
                                        <div className="footer-img">
                                            <img src="/assets/img/all-images/footer/footer-img1.png" alt="Kifah Business Park" />
                                            <div className="icons">
                                                <Link href="#">
                                                    <i className="fa-brands fa-instagram" />
                                                </Link>
                                    ...
                                    <div className="col-lg-4 col-4">
                                        <div className="footer-img">
                                            <img src="/assets/img/all-images/footer/footer-img2.png" alt="Kifah Business Park" />
                                            <div className="icons">
                                                <Link href="#">
                                                    <i className="fa-brands fa-instagram" />
                                                </Link>
                                    ...
                                    <div className="col-lg-4 col-4">
                                        <div className="footer-img">
                                            <img src="/assets/img/all-images/footer/footer-img3.png" alt="Kifah Business Park" />
                                            <div className="icons">
                                                <Link href="#">
                                                    <i className="fa-brands fa-instagram" />
                                                </Link>
                                    ...
                                    <div className="col-lg-4 col-4">
                                        <div className="footer-img">
                                            <img src="/assets/img/all-images/footer/footer-img4.png" alt="Kifah Business Park" />
                                            <div className="icons">
                                                <Link href="#">
                                                    <i className="fa-brands fa-instagram" />
                                                </Link>
                                    ...
                                    <div className="col-lg-4 col-4">
                                        <div className="footer-img">
                                            <img src="/assets/img/all-images/footer/footer-img5.png" alt="Kifah Business Park" />
                                            <div className="icons">
                                                <Link href="#">
                                                    <i className="fa-brands fa-instagram" />
                                                </Link>
                                    ...
                                    <div className="col-lg-4 col-4">
                                        <div className="footer-img">
                                            <img src="/assets/img/all-images/footer/footer-img6.png" alt="Kifah Business Park" />
                                            <div className="icons">
                                                <Link href="#">
                                                    <i className="fa-brands fa-instagram" />
                                                </Link>
                    ...
                    <div className="col-lg-12">
                        <div className="copyright-area">
                            <p>Ã‚Â© 2026 Kifah Business Park. All Rights Reserved.</p>
                            <ul>
                                <li>
