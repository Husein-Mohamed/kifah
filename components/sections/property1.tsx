                                                        ...
                                                        <SwiperSlide>
                                                            <Link href="/property-details-v1">
                                                                <div className="img1 image-anime">
                                                                    <img src="/assets/img/photos/IMG_1296.jpg" alt="Kifah Branding" />
                                                                </div>
                                                            </Link>
                                                        </SwiperSlide>
                                                        <SwiperSlide>
                                                            <Link href="/property-details-v1">
                                                                <div className="img1 image-anime">
                                                                    <img src="/assets/img/photos/IMG_1281.jpg" alt="Kifah Branding" />
                                                                </div>
                                                            </Link>
                                                        </SwiperSlide>
                                                        <SwiperSlide>
                                                            <Link href="/property-details-v1">
                                                                <div className="img1 image-anime">
                                                                    <img src="/assets/img/photos/IMG_1279.jpg" alt="Kifah Branding" />
                                                                </div>
                                                            </Link>
                                                        </SwiperSlide>
                                                ...
                                                <div className="property-single-boxarea">
                                                    <Swiper {...swiperOptions} className="property-list-img-area owl-carousel">
                                                        <SwiperSlide>
                                                            <Link href="/property-details-v1">
                                                                <div className="img1 image-anime">
                                                                    <img src="/assets/img/photos/IMG_1274.jpg" alt="Kifah Branding" />
                                                                </div>
                                                            </Link>
                                                        </SwiperSlide>
                                                        <SwiperSlide>
                                                            <Link href="/property-details-v1">
                                                                <div className="img1 image-anime">
                                                                    <img src="/assets/img/photos/IMG_1273.jpg" alt="Kifah Branding" />
                                                                </div>
                                                            </Link>
                                                        </SwiperSlide>
                                                        <SwiperSlide>
                                                            <Link href="/property-details-v1">
                                                                <div className="img1 image-anime">
                                                                    <img src="/assets/img/photos/IMG_1272.jpg" alt="Kifah Branding" />
                                                                </div>
                                                            </Link>
                                                        </SwiperSlide>
                                                        <div className="swiper-pagination" />
