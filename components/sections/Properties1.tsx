                    ...
                    <div className="row">
                        <div className="col-lg-6 m-auto">
                            <div className="heading1 text-center space-margin60">
                                ...
                                <h2 className="text-anime-style-3">Explore Our Business Facilities</h2>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-12" data-aos="zoom-out" data-aos-duration={1200}>
                            <div className="cs_case_study_1_list">
                                <div className={`cs_case_study cs_style_1 cs_hover_active ${activeIndex === 1 ? "active" : ""}`} onMouseEnter={() => setActiveIndex(1)}>
                                    <Link href="/case-single" className="cs_case_study_thumb cs_bg_filed" data-src="/assets/img/photos/IMG_1271.jpg" />
                                ...
                                <div className={`cs_case_study cs_style_1 cs_hover_active ${activeIndex === 2 ? "active" : ""}`} onMouseEnter={() => setActiveIndex(2)}>
                                    <Link href="/case-single" className="cs_case_study_thumb cs_case_study_thumb2 cs_bg_filed" data-src="/assets/img/photos/IMG_1270.jpg" />
                                    <div className="content-area">
                                        <div className="rent-sale-area">
                                            <ul>
                                                <li>
                                ...
                                <div className={`cs_case_study cs_style_1 cs_hover_active ${activeIndex === 3 ? "active" : ""}`} onMouseEnter={() => setActiveIndex(3)}>
                                    <Link href="/case-single" className="cs_case_study_thumb cs_case_study_thumb3 cs_bg_filed" data-src="/assets/img/photos/IMG_1269.jpg" />
                                    <div className="content-area">
                                        <div className="rent-sale-area">
                                            <ul>
                                                <li>
